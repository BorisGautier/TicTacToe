...
final int loseScore = 5;
final int tieScore = 10;
...
final defaultXskin = "assets/images/cross_skin.png";

final defaultOskin = "assets/images/circle_skin.png";

final String appStoreId = '123456789';

final String appFind =
    "Vous pouvez trouver notre application à partir de l'url ci-dessous \nAndroid:";

final String packageName = 'cm.tbg.tictactoe';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'cm.tbg.tictactoe';
final String iosLink = 'votre lien ios ici';
